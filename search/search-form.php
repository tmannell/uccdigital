<?php echo $this->form('search-form', $options['form_attributes']); ?>
    <div class="form-group">
        <?php echo $this->formText('query', $filters['query'], array('class'=>'form-control', 'placeholder'=>'Search all items')); ?>
        <button type="submit" id="nav-search" class="btn btn-default">Search</button>
    </div>
